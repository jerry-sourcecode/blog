...
而后，尝试让新的节点和其父节点交换位置。在这个例子中，显然，4是比6要小的，为了保证堆的性质，我们要让4和6换个位置。
...
显然，3是比4要小的，已经满足了堆的性质，这一次添加操作就此结束。
...
为了对上面一张图的顶点（即值为3的点）进行删除，我们可以这样做：
